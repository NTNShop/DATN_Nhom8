                ...
                <h4 className="card-title">Thêm sản phẩm</h4>
                    ...
                    <form class="form-horizontal form-material mx-2">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Nhập giá sản phẩm" class="form-control-line border-input"/>
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <label class="col-md-12 mb-0">Giảm giá</label>
                            <div class="col-md-12">
                                <input type="text" placeholder="Nhập giảm giá sản phẩm" class="form-control-line border-input"/>
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <label class="col-md-12 mb-0">Màu sắc</label>
                            <div class="col-md-12">
                                <input type="text" placeholder="Nhập màu sắc sản phẩm" class="form-control-line border-input"/>
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <label class="col-md-12 mb-0">Mô tả ngắn</label>
                            <div class="col-md-12">
                                <textarea rows="1" placeholder="Nhập mô tả ngắn" class=" border-input2 form-control-line"></textarea>
                            </div>
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12 d-flex">
                                <button class="btn btn-success mx-auto mx-md-0 text-white">Thêm sản phẩm</button>
                            </div>
                        </div>
                    </form>
                </div>
