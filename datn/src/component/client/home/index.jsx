    ...
    <div>
      ...
      <section className="video">
        ...
        <div className="tieudecona1">
          Chào mừng đến với BIKESCHOOL , nơi hành trình đạp xe của bạn bắt đầu!{" "}
          <br />
          Là những người đam mê đạp xe, chúng tôi hiểu được niềm vui và sự tự do
          khi đạp xe trên hai bánh xe
        </div>
      </section>
        ...
        <div className="slider-tong pt-4">
          <Slider {...settings}>
            <div className="slider-main pl-5">
              <div className="anh-slider">
                <img src={slide1} alt="Client 1" />
              </div>
            </div>
            <div className="slider-main pl-5">
              <div className="anh-slider">
                <img src={slide2} alt="Client 2" />
              </div>
            </div>
            <div className="slider-main pl-5">
              <div className="anh-slider">
                <img src={slide3} alt="Client 3" />
              </div>
            </div>
            <div className="slider-main pl-5">
              <div className="anh-slider">
                <img src={slide4} alt="Client 4" />
              </div>
            </div>
            <div className="slider-main pl-5">
              <div className="anh-slider">
                <img src={slide5} alt="Client 5" />
              </div>
            </div>
            <div className="slider-main pl-5">
              <div className="anh-slider">
                <img src={slide3} alt="Client 6" />
              </div>
            </div>
          </Slider>
        </div>
      ...
      <section className="wheel-pather">
        <div className="col-100 d-flex">
          <div
            data-aos="fade-right"
            className="col-40 d-flex flex-column justify-content-center"
          >
            ...
            <p style={{ color: "#707070", fontSize: "19px" }}>
              Chúng tôi cung cấp cho bạn những dòng xe chất lượng cao và sức bền
              vượt trội, xe được thiết kế bởi các chuyên gia trong nghành bảo
              đảm mang đến chất lượng tốt nhất cho khách hàng và là niềm tin
              vững chắc của thị trường xe đạp tại Việt Nam
            </p>
          </div>
          <div
            data-aos="fade-left"
            className="col-60 d-flex justify-content-center align-items-center"
          >
            <img
      ...
      >
        <div className="sec-100">
          ...
          <div className="col-60 col-60-2 ">
            <h1 className="suutam" style={{ textAlign: "left" }}>
              SƯU TẦM
            </h1>
            <hr style={{ width: "300px", color: "white", height: "2px" }} />
            <p style={{ color: "white" }}>
              Nhiều người, không chịu được vị đắng của cà phê nên thường bỏ
              đường hoặc sữa cho bớt đắng. Tôi không cho đường hay sữa vào cà
              phê bởi tôi biết phải nếm trải qua cay đắng mới cảm nhận được ngọt
              ngào đến lịm người. Cho dù vẫn tiếp tục phải uống cà phê đắng
              nhưng tôi vẫn không nản lòng vì dư vị ngọt ngào của nó.
            </p>
          </div>
        </div>
            ...
            <div className="subcate2 row ">
                ...
                <div className="col-10 p-2 frame-category">
                  <div className=" d-flex justify-content-center">
                    <img
                      style={{ width: "200px" }}
                      src={imgCategory}
                      alt="image-category-children-bicycle"
                    />
                  </div>
                  <div className="w-100">
                  ...
                  <div className="w-100">
                    <h6>
                      Xe đạp bền chắc, thiết kế an toàn, màu sắc tươi sáng, giúp
                      bé vui chơi và rèn luyện sức khỏe, là lựa chọn hàng đầu
                      cho trẻ em phát triển.
                    </h6>
                  </div>
                  <div className="d-flex align-items-center justify-content-between">
                    <a href="#" className="btn btn-dark">
                      Chi Tiết <i className="bi bi-arrow-right-square"></i>
                    </a>
                    <div className="pl-5">Được cập nhật: 18/11/2024</div>
                  </div>
                </div>
              </div>
              <div className="col-3  d-flex justify-content-center align-items-center pt-2 pb-2 p-0">
                  ...
                  >
                    <img
                      style={{
                        width: "auto",
                        height: "100%",
                        objectFit: "contain", // Giữ nguyên tỉ lệ hình ảnh ko bị kéo dài
                      }}
                      src={sp}
                      alt="image-category-children-bicycle"
                    />
              ...
              <div className="col-3  d-flex justify-content-center align-items-center pt-2 pb-2 p-0">
                <div className="col-10 p-2  frame-category">
                  ...
                  <div className="d-flex align-items-center justify-content-between">
                    <a href="#" className="btn btn-dark">
                      Chi Tiết <i class="bi bi-arrow-right-square"></i>
                    </a>
                    <div className="pl-5">Được cập nhật: 18/11/2024</div>
                  </div>
                </div>
              ...
              <div className="col-3  d-flex justify-content-center align-items-center pt-2 pb-2 p-0">
                <div className="col-10 p-2  frame-category">
                  ...
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div className="pl-5">Được cập nhật: 10/11/2024</div>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="col-7 d-flex justify-content-start align-items-center row">
                  ...
                  >
                    <span className="text-dark">
                      Thiết kế sạch sẽ và vượt thời gian khiến mọi chuyến đi trở
                      nên thú vị. Dù bạn đi đâu, xe đạp
                    </span>{" "}
                    của chúng tôi đều được thiết kế để giúp việc đi lại hàng
                    ngày của bạn trở nên thú vị.
                  </p>
                  <p className="">
                    Đây không phải là xe đạp. Đây là một tác phẩm nghệ thuật khí
                    động học, khuấy động tâm hồn, mang lại nụ cười trên khuôn
                    mặt bạn. Được thiết kế để đưa bạn đi khắp thế giới mà không
                    cần sức nặng của nó. Nơi hành trình đạp xe của bạn bắt đầu!
                    Là những người đam mê đạp xe chứ không phải chúng tôi, chúng
                    tôi hiểu niềm vui và sự tự do đến từ việc đạp xe
                  </p>
                </div>
          ...
          <div className="row">
            <div className="col-lg-5 pt-5">
              ...
              <div className="div-title  text-dark">
                <p>
                  các bài viết, blog về hoạt động xe đạp được cập nhật liên tục
                  từ các bài báo và truyền thông về xe đạp !{" "}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="col-lg-4 col-md-4 col-sm-4">
              <div className="blog__item">
                ...
                <div className="blog__item__text">
                  ...
                  <h5>
                    <a href="#">
                      237 vận động viên tranh tài tại Giải Đua xe đạp
                    </a>
                  </h5>
                  <p>
