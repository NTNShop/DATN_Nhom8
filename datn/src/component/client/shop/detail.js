...
const renderReviewSection = () => (
    <div className="card">
        <div className="card-header bg-white d-flex justify-content-between align-items-center">
            <h4 className="mb-0">Đánh giá từ khách hàng ({reviews.length})</h4>
            <div className="text-muted">
                <small>Đánh giá cho: {product?.name}</small>
            </div>
        </div>
        <div className="card-body">
            {reviews.length > 0 ? (
                reviews.map((review) => (
                    <div key={review.review_id} className="card mb-3 border-0 border-bottom">
                        <div className="card-body">
                            <div className="d-flex justify-content-between align-items-center mb-2">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div>
                                        <strong className="d-block">{review.full_name}</strong>
                                        <div className="d-flex align-items-center">
                            ...
                            <p className="mb-0 text-secondary">{review.review_content}</p>
                        </div>
                    </div>
                ))
            ) : (
