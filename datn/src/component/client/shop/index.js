                                ...
                                <div className="latest-product__text">
                                    ...
                                    <div className="latest-product__slider owl-carousel">
                                        <div className="latest-prdouct__slider__item">
                                            ...
                                            <Link to="/detail" className="latest-product__item">
                                    ...
                                    <div className="product__discount__item">
                                        <div className="product__discount__item__pic">
                                            ...
                                            <ul className="product__item__pic__hover">
                                                ...
                                                <li><Link to="/detail"><i className="fa fa-retweet"></i></Link></li>
                                                <li><a href="#"><i className="fa fa-shopping-cart"></i></a></li>
                                            </ul>
                                        </div>
                                        <div className="product__discount__item__text">
                                            <h5><Link to="/detail">Xe tay ga</Link></h5>
                                            <div className="product__item__price">40.000.000đ<span>45.000.000đ</span></div>
                                        </div>
                                    </div>
                                </div>
